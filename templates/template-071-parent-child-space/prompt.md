...
- 網站主題：親子天地
- 產業分類：親子
- 核心描述：親子空間模板，採用柔和粉彩色系設計
- 技術框架：Bootstrap 5
- 首頁 title 參考：小星球｜親子空間
- Hero 主標方向：讓孩子 / 在玩樂中 學習
...
【每個頁面的內容職責】
- index.html：導覽文案為「🌟 小星球」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
