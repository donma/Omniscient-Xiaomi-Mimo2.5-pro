...
【樣板定位】
- 樣板 ID：T042
- 網站主題：Marketing Agency / 行銷公司
- 產業分類：創意設計
- 核心描述：專業數位行銷服務，SEO、SEM、社群行銷、內容行銷，數據驅動的行銷策略。
- 技術框架：Bootstrap 5
- 首頁 title 參考：行銷公司 | 數據驅動行銷
- Hero 主標方向：用數據說話 / 讓成長可見
- Meta description 參考：專業數位行銷服務，SEO、SEM、社群行銷、內容行銷，數據驅動的行銷策略。
...
【每個頁面的內容職責】
- index.html：導覽文案為「GrowthLab」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
