...
- 網站主題：寵物美容 / 毛孩美容屋
- 產業分類：pets
- 核心描述：溫馨可愛的寵物美容網站模板，具有俏皮設計元素、服務預約和寵物護理知識。
- 技術框架：Bootstrap 5
- 首頁 title 參考：毛孩美容屋 | 專業寵物美容服務
- Hero 主標方向：讓您的毛孩 / 🐾 煥然一新
- Meta description 參考：毛孩美容屋提供專業寵物美容服務，讓您的毛孩煥然一新。
...
【每個頁面的內容職責】
- index.html：導覽文案為「毛孩美容屋」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- portfolio.html：導覽文案為「作品集」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- reviews.html：導覽文案為「好評推薦」。評價頁：整理客戶見證、推薦內容、成果回饋與信任背書。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- blog.html：導覽文案為「毛孩知識」。文章列表頁：整理內容分類、精選文章卡片與延伸閱讀 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
