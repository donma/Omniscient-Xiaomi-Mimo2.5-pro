...
【樣板定位】
- 樣板 ID：T007
- 網站主題：APEX Fitness / 極限健身
- 產業分類：健身教練
- 核心描述：高能量、大膽風格的健身教練網站模板，適合個人教練、健身房、運動中心使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：極限健身 | Fitness Coach
- Hero 主標方向：突破極限 / 成就自我
...
【每個頁面的內容職責】
- index.html：導覽文案為「極限健身」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- portfolio.html：導覽文案為「成果」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
