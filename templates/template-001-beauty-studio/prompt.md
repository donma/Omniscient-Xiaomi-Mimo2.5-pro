...
- 網站主題：璀璨美學
- 產業分類：美容美學
- 核心描述：優雅女性風格的美容院網站模板，適合美容護膚、美甲美睫等服務業使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：璀璨美學 | Beauty Studio
- Hero 主標方向：綻放你的 / 獨特光芒
...
【每個頁面的內容職責】
- index.html：導覽文案為「璀璨美學」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「立即預約」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- process.html：流程頁：清楚說明合作步驟、服務節點、時間安排與交付方式。
- blog.html：導覽文案為「美容日誌」。文章列表頁：整理內容分類、精選文章卡片與延伸閱讀 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
