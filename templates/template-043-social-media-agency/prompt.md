# T043 Social Media Agency Prompt
...
【樣板定位】
- 樣板 ID：T043
- 網站主題：Social Media Agency / 社群代理
- 產業分類：創意設計
- 核心描述：專業社群媒體代理服務，Facebook、Instagram、YouTube、TikTok 社群經營。
- 技術框架：Bootstrap 5
- 首頁 title 參考：社群代理 | 專業社群媒體經營
- Hero 主標方向：讓您的品牌 / 在社群發光
- Meta description 參考：專業社群媒體代理服務，Facebook、Instagram、YouTube、TikTok 社群經營。
...
【每個頁面的內容職責】
- index.html：導覽文案為「SocialBoost」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：導覽文案為「關於我們」。關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- services.html：導覽文案為「服務項目」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「免費審計」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
