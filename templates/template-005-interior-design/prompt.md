...
- 網站主題：沐沐設計 / 境域設計
- 產業分類：室內設計
- 核心描述：建築感、乾淨線條風格的室內設計網站模板，適合設計公司、建築師事務所使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：境域設計 | Interior Design
- Hero 主標方向：境域設計
...
【每個頁面的內容職責】
- index.html：導覽文案為「境域設計」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- process.html：導覽文案為「流程」。流程頁：清楚說明合作步驟、服務節點、時間安排與交付方式。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
