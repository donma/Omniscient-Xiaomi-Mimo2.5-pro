...
【樣板定位】
- 樣板 ID：T044
- 網站主題：Video Production / 影片製作
- 產業分類：創意設計
- 核心描述：專業影片製作服務，企業形象影片、廣告影片、紀錄片、MV 製作。
- 技術框架：Bootstrap 5
- 首頁 title 參考：影片製作 | 專業影像製作公司
- Hero 主標方向：用影像說故事 / 感動人心
- Meta description 參考：專業影片製作服務，企業形象影片、廣告影片、紀錄片、MV 製作。
...
【每個頁面的內容職責】
- index.html：導覽文案為「黑盒子影像」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「開始專案」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
