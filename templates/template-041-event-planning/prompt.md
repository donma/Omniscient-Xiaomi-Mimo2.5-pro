...
【樣板定位】
- 樣板 ID：T041
- 網站主題：Event Planning / 活動企劃
- 產業分類：創意設計
- 核心描述：專業活動企劃服務，企業活動、婚禮、展覽、派對，讓您的活動完美呈現。
- 技術框架：Bootstrap 5
- 首頁 title 參考：活動企劃 | 專業活動策劃服務
- Hero 主標方向：讓每一個活動 / 成為永恆回憶
- Meta description 參考：專業活動企劃服務，企業活動、婚禮、展覽、派對，讓您的活動完美呈現。
...
【每個頁面的內容職責】
- index.html：導覽文案為「璀璨活動」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- portfolio.html：導覽文案為「活動作品」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
