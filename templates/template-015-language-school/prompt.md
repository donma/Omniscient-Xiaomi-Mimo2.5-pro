...
- 核心描述：專業語言教育網站模板
- 技術框架：Bootstrap 5
- 首頁 title 參考：語樂語言中心 | 專業語言學習
- Hero 主標方向：開啟您的 / 語言學習 之旅
...
【每個頁面的內容職責】
- index.html：導覽文案為「語樂語言」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：導覽文案為「關於我們」。關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- services.html：導覽文案為「課程項目」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- service-detail.html：服務詳情頁：深度說明單一服務的價值、流程、對象、FAQ 與 CTA。
- portfolio.html：導覽文案為「學習成果」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- reviews.html：導覽文案為「學員評價」。評價頁：整理客戶見證、推薦內容、成果回饋與信任背書。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- faq.html：FAQ 頁：用手風琴或條列方式解答常見問題，降低諮詢門檻。
- booking.html：導覽文案為「免費試聽」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- process.html：流程頁：清楚說明合作步驟、服務節點、時間安排與交付方式。
- blog.html：導覽文案為「語言專欄」。文章列表頁：整理內容分類、精選文章卡片與延伸閱讀 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
