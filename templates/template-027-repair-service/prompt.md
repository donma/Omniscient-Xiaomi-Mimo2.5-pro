...
- 網站主題：修匠工坊
- 產業分類：維修服務
- 核心描述：維修服務工業風格網站模板，適合家電維修、水電行、綜合維修服務使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：修匠工坊｜專業維修服務
- Hero 主標方向：專業維修 / 馬上 搞定
- Meta description 參考：修匠工坊，專業居家維修、水電、冷氣維修服務。
...
【每個頁面的內容職責】
- index.html：導覽文案為「修匠工坊」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「立即報修」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
