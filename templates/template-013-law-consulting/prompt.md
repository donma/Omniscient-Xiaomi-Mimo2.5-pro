...
- 樣板 ID：T013
- 網站主題：法律顧問 / 正信法律事務所
- 產業分類：professional-services
- 核心描述：權威法律顧問網站模板，具有威望設計、律師介紹和諮詢預約功能。
- 技術框架：Bootstrap 5
- 首頁 title 參考：正信法律事務所 | 專業法律諮詢服務
- Hero 主標方向：守護您的 / 法律權益
- Meta description 參考：正信法律事務所提供專業法律諮詢服務，包括民事訴訟、刑事辯護、企業法務等。
...
【每個頁面的內容職責】
- index.html：導覽文案為「正信法律」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- blog.html：導覽文案為「法律專欄」。文章列表頁：整理內容分類、精選文章卡片與延伸閱讀 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
