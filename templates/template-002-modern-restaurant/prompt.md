...
- 網站主題：御膳坊
- 產業分類：餐廳美食
- 核心描述：溫暖食慾風格的餐廳網站模板，適合中式料理、西式餐廳、美食餐廳等餐飲業使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：御膳坊 | Modern Restaurant
- Hero 主標方向：品味經典 / 饗宴時刻
...
【每個頁面的內容職責】
- index.html：導覽文案為「御膳坊」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- portfolio.html：導覽文案為「美食集錦」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- reviews.html：導覽文案為「顧客評價」。評價頁：整理客戶見證、推薦內容、成果回饋與信任背書。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- faq.html：FAQ 頁：用手風琴或條列方式解答常見問題，降低諮詢門檻。
- booking.html：導覽文案為「線上訂位」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- process.html：流程頁：清楚說明合作步驟、服務節點、時間安排與交付方式。
- blog.html：導覽文案為「美食日誌」。文章列表頁：整理內容分類、精選文章卡片與延伸閱讀 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
