...
- 網站主題：極致車藝
- 產業分類：汽車服務
- 核心描述：汽車美容專業風格網站模板，適合汽車美容店、鍍膜服務、汽車保養使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：極致車藝 | 專業汽車美容
- Hero 主標方向：極致 / 車藝美學
...
【每個頁面的內容職責】
- index.html：導覽文案為「極致車藝」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- reviews.html：導覽文案為「客戶評價」。評價頁：整理客戶見證、推薦內容、成果回饋與信任背書。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- faq.html：導覽文案為「常見問題」。FAQ 頁：用手風琴或條列方式解答常見問題，降低諮詢門檻。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- booking.html：導覽文案為「預約服務」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- process.html：流程頁：清楚說明合作步驟、服務節點、時間安排與交付方式。
- blog.html：導覽文案為「汽車知識」。文章列表頁：整理內容分類、精選文章卡片與延伸閱讀 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
