...
- 網站主題：木匠工坊
- 產業分類：家具
- 核心描述：家具品牌模板，採用灰色與棕色的穩重設計
- 技術框架：Bootstrap 5
- 首頁 title 參考：沐居｜北歐風格家具
- Hero 主標方向：讓家 / 回到 純粹
- Meta description 參考：沐居，北歐風格家具選物，打造舒適居家空間。
...
【每個頁面的內容職責】
- index.html：導覽文案為「沐居 MUJU」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- portfolio.html：導覽文案為「空間案例」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- reviews.html：評價頁：整理客戶見證、推薦內容、成果回饋與信任背書。
- faq.html：FAQ 頁：用手風琴或條列方式解答常見問題，降低諮詢門檻。
- booking.html：導覽文案為「預約參觀」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
