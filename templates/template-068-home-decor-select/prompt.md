...
- 網站主題：生活選物
- 產業分類：家飾
- 核心描述：家飾選物模板，採用溫暖色調的雜誌風格設計
- 技術框架：Bootstrap 5
- 首頁 title 參考：拾物｜生活風格選物
- Hero 主標方向：為生活 / 挑選 美好
- Meta description 參考：拾物，精選國內外生活風格品牌，打造有溫度的居家空間。
...
【每個頁面的內容職責】
- index.html：導覽文案為「拾物」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：導覽文案為「品牌」。關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- services.html：導覽文案為「選物」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
