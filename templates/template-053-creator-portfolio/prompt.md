...
【樣板定位】
- 樣板 ID：T053
- 網站主題：Creator Portfolio / CreativeMind
- 產業分類：Creative
- 核心描述：Minimalist black-white creator portfolio
- 技術框架：Bootstrap 5
- 首頁 title 參考：CreativeMind
- Hero 主標方向：創意無限 作品說話
...
【每個頁面的內容職責】
- index.html：導覽文案為「CreativeMind」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「合作洽詢」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
