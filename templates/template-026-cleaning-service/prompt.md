...
- 網站主題：淨白清潔
- 產業分類：清潔服務
- 核心描述：清潔服務專業風格網站模板，適合清潔公司、居家清潔、商業清潔使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：淨白清潔｜專業清潔服務
- Hero 主標方向：讓空間 / 回到最初的 潔淨
- Meta description 參考：淨白清潔，專業居家與商業清潔服務。
...
【每個頁面的內容職責】
- index.html：導覽文案為「💧 淨白清潔」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
