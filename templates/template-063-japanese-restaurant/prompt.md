...
- 網站主題：和風料理
- 產業分類：日本料理
- 核心描述：日本料理模板，採用禪意設計風格搭配紅色點綴
- 技術框架：Bootstrap 5
- 首頁 title 參考：禪意料理｜日式割烹
- Hero 主標方向：一期一會
- Meta description 參考：禪意料理，正宗日式割烹，預約制精緻料理。
...
【每個頁面的內容職責】
- index.html：導覽文案為「禪 意」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：導覽文案為「料理長」。關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
