...
【樣板定位】
- 樣板 ID：T076
- 網站主題：Outdoor Equipment / ▲ 山岳裝備
- 產業分類：零售商品
- 核心描述：山岳裝備提供專業戶外登山、露營、健行裝備，精選全球頂級戶外品牌。
- 技術框架：Bootstrap 5
- 首頁 title 參考：山岳裝備｜專業戶外用品專賣
- Hero 主標方向：征服每一座山峰
- Meta description 參考：山岳裝備提供專業戶外登山、露營、健行裝備，精選全球頂級戶外品牌。
...
【每個頁面的內容職責】
- index.html：導覽文案為「▲ 山岳裝備」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- portfolio.html：導覽文案為「裝備圖鑑」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
