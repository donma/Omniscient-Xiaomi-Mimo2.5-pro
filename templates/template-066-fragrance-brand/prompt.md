...
- 網站主題：香氛世家
- 產業分類：香氛
- 核心描述：香氛品牌模板，採用白色與金色的優雅設計
- 技術框架：Bootstrap 5
- 首頁 title 參考：NOIR 香氛｜精品香氛品牌
- Hero 主標方向：你的氣息 / 你的 態度
- Meta description 參考：NOIR 香氛，法國進口精品香氛，打造專屬氣息。
- 視覺關鍵字：高級感、精緻留白、柔和質感、品牌美學
...
【每個頁面的內容職責】
- index.html：導覽文案為「NOIR」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：導覽文案為「品牌」。關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- services.html：導覽文案為「系列」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「選購」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- contact.html：導覽文案為「專櫃」。聯絡頁：提供表單、聯絡資訊、地圖、社群與聯絡 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
