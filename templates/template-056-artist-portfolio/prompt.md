...
【樣板定位】
- 樣板 ID：T056
- 網站主題：Artist Portfolio / GalleryArt
- 產業分類：Creative
- 核心描述：Gallery-white artist portfolio
- 技術框架：Bootstrap 5
- 首頁 title 參考：GalleryArt
- Hero 主標方向：藝術無界 創作永恆
- Meta description 請依服務價值與信任感撰寫。
- 視覺關鍵字：個人品牌、編輯感、內容驅動、作品導向
...
【每個頁面的內容職責】
- index.html：導覽文案為「GalleryArt」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「聯絡藝術家」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- exhibitions.html：請依檔名語意與整體品牌脈絡補齊完整內頁內容與 CTA。
