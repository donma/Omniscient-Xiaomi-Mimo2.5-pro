...
【樣板定位】
- 樣板 ID：T078
- 網站主題：Hot Spring Hotel
- 產業分類：旅遊休閒
- 核心描述：嵐之湯｜溫泉旅館
- 技術框架：Bootstrap 5
- 首頁 title 參考：嵐之湯｜溫泉旅館
- Hero 主標方向：浸泡在 / 自然的 懷抱
...
【每個頁面的內容職責】
- index.html：導覽文案為「嵐之湯」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。
- services.html：導覽文案為「湯屋」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- contact.html：導覽文案為「預約」。聯絡頁：提供表單、聯絡資訊、地圖、社群與聯絡 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
