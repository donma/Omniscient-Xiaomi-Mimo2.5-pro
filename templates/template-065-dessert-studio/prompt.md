...
- 網站主題：甜蜜工坊
- 產業分類：甜點
- 核心描述：甜點工作室模板，採用粉色系夢幻設計
- 技術框架：Bootstrap 5
- 首頁 title 參考：甜蜜工坊｜手作甜點
- Hero 主標方向：每一口 / 都是 幸福
- Meta description 參考：甜蜜工坊，手作法式甜點，客製化蛋糕訂購。
- 視覺關鍵字：生活風格、品牌敘事、圖片導向、溫度感
...
【每個頁面的內容職責】
- index.html：導覽文案為「Sweet Studio」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。
- services.html：導覽文案為「甜點」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「預約到店」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- contact.html：導覽文案為「訂購」。聯絡頁：提供表單、聯絡資訊、地圖、社群與聯絡 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
