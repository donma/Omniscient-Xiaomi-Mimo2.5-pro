...
- 網站主題：NOIR 時尚精品 / NOIR
- 產業分類：時尚服飾
- 核心描述：極簡奢華風格的時尚服飾網站模板，適合精品服飾、設計師品牌、時尚選物店使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：NOIR | Fashion Boutique
- Hero 主標方向：夏日 / 新浪潮
...
- services.html：導覽文案為「新品」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- service-detail.html：服務詳情頁：深度說明單一服務的價值、流程、對象、FAQ 與 CTA。
- portfolio.html：導覽文案為「系列」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- blog.html：導覽文案為「日誌」。文章列表頁：整理內容分類、精選文章卡片與延伸閱讀 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
