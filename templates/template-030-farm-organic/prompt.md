...
- 網站主題：綠野農莊
- 產業分類：農業品牌
- 核心描述：有機農場自然風格網站模板，適合有機農場、農產品品牌、農場體驗使用。
- 技術框架：Bootstrap 5
- 首頁 title 參考：綠野農莊｜有機農場
- Hero 主標方向：從田間 / 到 餐桌
- Meta description 參考：綠野農莊，有機種植，從田間到餐桌的安心。
...
【每個頁面的內容職責】
- index.html：導覽文案為「綠野農莊」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
