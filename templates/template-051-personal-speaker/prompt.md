...
【樣板定位】
- 樣板 ID：T051
- 網站主題：Personal Speaker
- 產業分類：Professional
- 核心描述：Bold dark speaker portfolio with stage presence
- 技術框架：Bootstrap 5
- 首頁 title 參考：張大偉｜企業講師 · 人生教練
- Hero 主標方向：用故事 / 改變世界
- Meta description 參考：張大偉，知名企業講師，專注領導力、溝通、團隊建設培訓。
...
【每個頁面的內容職責】
- index.html：導覽文案為「張大偉」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- portfolio.html：導覽文案為「演講」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- reviews.html：評價頁：整理客戶見證、推薦內容、成果回饋與信任背書。
- faq.html：FAQ 頁：用手風琴或條列方式解答常見問題，降低諮詢門檻。
- booking.html：導覽文案為「邀約演講」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- contact.html：導覽文案為「邀約」。聯絡頁：提供表單、聯絡資訊、地圖、社群與聯絡 CTA。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
