...
- 網站主題：鍋物天堂
- 產業分類：火鍋
- 核心描述：火鍋餐廳模板，採用紅色與橙色的熱情配色
- 技術框架：Bootstrap 5
- 首頁 title 參考：暖心火鍋｜正宗台式火鍋
- Hero 主標方向：暖心火鍋
- Meta description 參考：暖心火鍋，嚴選食材、湯頭濃郁，最暖心的火鍋體驗。
...
【每個頁面的內容職責】
- index.html：導覽文案為「🔥 暖心火鍋」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
