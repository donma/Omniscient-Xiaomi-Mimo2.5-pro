...
【樣板定位】
- 樣板 ID：T050
- 網站主題：Chinese Medicine
- 產業分類：Health
- 核心描述：Traditional Chinese medicine with Eastern earth tones
- 技術框架：Bootstrap 5
- 首頁 title 參考：仁心中醫｜傳統智慧 現代醫療
- Hero 主標方向：傳統智慧 / 現代醫療
- Meta description 參考：仁心中醫診所，結合傳統中醫智慧與現代醫療技術。
...
【每個頁面的內容職責】
- index.html：導覽文案為「仁心中醫」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：導覽文案為「醫師介紹」。關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- faq.html：導覽文案為「常見問題」。FAQ 頁：用手風琴或條列方式解答常見問題，降低諮詢門檻。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- booking.html：導覽文案為「預約掛號」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
