...
- 網站主題：環球物流
- 產業分類：Logistics
- 核心描述：環球物流提供海運、空運、陸運、倉儲等全方位物流服務，覆蓋全球 50+ 國家。
- 技術框架：Bootstrap 5
- 首頁 title 參考：環球物流 | 全球貨運解決方案
- Hero 主標方向：全球物流 / 使命必達
- Meta description 參考：環球物流提供海運、空運、陸運、倉儲等全方位物流服務，覆蓋全球 50+ 國家。
...
【每個頁面的內容職責】
- index.html：導覽文案為「環球物流」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「取得報價」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
