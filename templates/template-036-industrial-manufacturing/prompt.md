# T036 Industrial Manufacturing Prompt
...
【樣板定位】
- 樣板 ID：T036
- 網站主題：Industrial Manufacturing / 精密工業
- 產業分類：科技商務
- 核心描述：精密工業提供 CNC 加工、模具設計、自動化產線等專業製造服務，服務全球客戶。
- 技術框架：Bootstrap 5
- 首頁 title 參考：精密工業 | 專業製造解決方案
- Hero 主標方向：精密製造 / 驅動產業升級
- Meta description 參考：精密工業提供 CNC 加工、模具設計、自動化產線等專業製造服務，服務全球客戶。
- 視覺關鍵字：工業專業、穩定可靠、強結構感、效率導向
...
【每個頁面的內容職責】
- index.html：導覽文案為「精密工業」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- about.html：導覽文案為「關於我們」。關於頁：介紹品牌背景、理念、團隊、專業優勢與信任建立內容。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- services.html：導覽文案為「產品服務」。服務總覽頁：整理主要服務、方案、功能或產品分類，方便比較與導流。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- service-detail.html：服務詳情頁：深度說明單一服務的價值、流程、對象、FAQ 與 CTA。
- portfolio.html：導覽文案為「生產實績」。案例/作品頁：呈現精選案例、作品成果、情境照片或實績展示。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
- reviews.html：評價頁：整理客戶見證、推薦內容、成果回饋與信任背書。
- faq.html：FAQ 頁：用手風琴或條列方式解答常見問題，降低諮詢門檻。
- booking.html：導覽文案為「線上詢價」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
