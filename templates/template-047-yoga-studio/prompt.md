...
- 樣板 ID：T047
- 網站主題：Yoga Studio
- 產業分類：Health & Wellness
- 核心描述：Serene yoga studio website with zen calm design, class scheduling, instructor profiles, and wellness blog.
- 技術框架：Bootstrap 5
- 首頁 title 參考：ZenFlow 禪意瑜珈｜找回內在平靜
- Hero 主標方向：找回 / 內在的 平靜
- Meta description 參考：ZenFlow 禪意瑜珈，專業瑜珈課程，找回身心平衡。
...
【每個頁面的內容職責】
- index.html：導覽文案為「ZenFlow」。首頁：建立第一印象，包含 hero、核心賣點、代表性內容區塊、轉換 CTA 與完整 footer。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
...
- booking.html：導覽文案為「預約體驗」。預約/諮詢頁：提供表單、預約流程、方案說明與行動呼籲。 如果檔名與實際頁面定位略有差異，請以導覽文案與整體樣板脈絡優先。
